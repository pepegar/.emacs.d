...
#+BEGIN_SRC emacs-lisp
(use-package xresources-theme :pin melpa :ensure t :defer t)
...
(use-package lsp-ui :ensure t :pin melpa-stable)
(require 'lsp-ui)

(use-package lsp-mode :ensure t :pin melpa-stable)
